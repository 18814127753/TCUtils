...
public class FTPUtil {
    ...
    public InputStream retrieveFile(String ftpFileName) throws IOException {
    ...
    public void sendCommand(String ops,String value) throws IOException {
    	if (ftpClient.isConnected()) {
    		ftpClient.sendCommand(ops,value);
    	}
    }
